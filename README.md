...
1. Select **New custom wheel...** from the dropdown, enter a name, and click
   **Create wheel** (or press Enter). Each saved wheel appears as **Custom: Name**
   in the same dropdown.
2. Type an item in **New entry** below the scrollable list and click **Add**, or
...
10. Create two custom wheels, add several entries, disable one and delete another.
    ...
    below the list in short and tall sidebars. Confirm Space/Enter work when typing.
